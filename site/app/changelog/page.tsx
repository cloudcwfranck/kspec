                ...
                <article key={release.id} className="relative">
                  ...
                  <div className="flex items-center gap-3 mb-8">
                    <div className="flex items-center gap-2">
                      ...
                      <time className="text-sm text-linear-text-secondary font-medium">
                  ...
                  {/* Title */}
                  <h2 className="text-3xl font-bold text-linear-text mb-8 tracking-tight">
                  ...
                  <div className="space-y-6">
                    {lines.map((line, idx) => {
                      ...
                      if (line.startsWith('## ')) {
                        return (
                          <h3 key={idx} className="text-xl font-semibold text-linear-text mt-10 mb-4">
                            {line.replace('## ', '')}
                          </h3>
                        );
                      }
                      ...
                      if (line.startsWith('### ')) {
                        return (
                          <h4 key={idx} className="text-base font-semibold text-linear-text mt-6 mb-3">
                            {line.replace('### ', '')}
                          </h4>
                        );
                      }
                      ...
                      if (line.match(/^\*\*.*\*\*$/)) {
                        return (
                          <p key={idx} className="text-linear-text font-medium mt-6">
                            {line.replace(/\*\*/g, '')}
                          </p>
                        );
                      }
                      ...
                      if (line.trim() && !line.startsWith('#')) {
                        return (
                          <p key={idx} className="text-linear-text-secondary leading-relaxed">
                            {line}
                          </p>
                        );
                      }
